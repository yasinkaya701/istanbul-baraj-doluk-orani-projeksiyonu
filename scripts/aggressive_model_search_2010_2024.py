...
OUT_DIR = ROOT / "output" / "istanbul_aggressive_model_search_2010_2024"

# User request: "15 yıllık bak"
# Train <= 2009-12, test 2010-01 .. 2024-02 (≈14.1 yıl; mevcut verinin sonuna kadar).
...
def main() -> None:
    ...
    pred_df.to_csv(OUT_DIR / "aggressive_direct_level_predictions_2010_2024.csv", index=False)
    ...
    ax.set_title("Agresif arama - en iyi direct level modeller (2010-2024 holdout)")
    ...
    summary = {
        "target": "strict train<=2009-12 / test 2010-2024",
